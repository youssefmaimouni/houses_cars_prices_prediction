...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden  duration-300 ease-linear bg-black lg:static lg:translate-x-0 ${
            ...
            <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-meta-4 ${
                    pathname.includes('tables') && 'bg-meta-4'
                  }`}
                >
                  <svg
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/' || pathname.includes('Anlyse')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-meta-4 ${
                          (pathname === '/' ||
                            pathname.includes('Anlyse')) &&
                          'bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
              ...
              {/* <li>
                <NavLink
                  to="/profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-meta-4 ${
                    pathname.includes('profile') && 'bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/Data_Cleaning' || pathname.includes('Data Cleaning')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-meta-4 ${
                          (pathname === '/Data_Cleaning' ||
                            pathname.includes('Data Cleaning')) &&
                          'bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                       <svg fill="none" className='fill-current' width="20" height="20" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                        <title>clean</title>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <NavLink
                              to="/Data_Cleaning/Houses"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
                              Houses Data Cleaning
                            </NavLink>
                          </li>
                        </ul>
                      </div>
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/Models' || pathname.includes('Models')
                }
              >
                {(handleClick, open) => {
                  return (
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <li>
                <NavLink
                  to="/chart"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-meta-4 ${
                    pathname.includes('chart') && 'bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
