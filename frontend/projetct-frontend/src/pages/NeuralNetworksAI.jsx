  ...
  return (
      <div className="w-full mx-auto bg-white p-10 shadow rounded">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-gray-800 mb-4"> Réseaux de Neurones Artificiels</h2>

          <h3 className="font-semibold text-gray-800">Définition</h3>
          ...
          <img src="/images/neural_network_definition.png" alt="Définition des réseaux de neurones" className="my-4 w-full rounded" />

          <h3 className="font-semibold text-gray-800 mt-6">Architecture</h3>
          <p className="text-gray-700 leading-relaxed">
          ...
          <img src="/images/neural_network_architecture.png" alt="Architecture des réseaux de neurones" className="my-4 w-full rounded" />

          <h3 className="font-semibold text-gray-800 mt-6">Fonctionnement des Couches</h3>
          ...
          <img src="/images/neural_layers_function.png" alt="Fonctionnement des couches" className="my-4 w-full rounded" />

          <h3 className="font-semibold text-gray-800 mt-6">Fonctionnement des Neurones</h3>
          <p className="text-gray-700 leading-relaxed">
          ...
          <img src="/images/neuron_functionality.png" alt="Fonctionnement des neurones" className="my-4 w-full rounded" />
        </section>

        {/* Section  Apprentissage des réseaux de neurones artificiels */}
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-gray-800 mb-4"> Apprentissage des Réseaux de Neurones Artificiels</h2>
          <p className="text-gray-700 leading-relaxed">
          ...
          <img src="/images/neural_learning_process.png" alt="Processus d'apprentissage" className="my-4 w-full rounded" />
        </section>

        {/* Section  Fonction de Coût */}
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-gray-800 mb-4"> Fonction de Coût</h2>
          <p className="text-gray-700 leading-relaxed">
          ...
          <img src="/images/cost_function_example.png" alt="Exemple de fonction de coût" className="my-4 w-full rounded" />
        </section>

        {/* Section  Principe de Rétropropagation */}
        <section>
          <h2 className="text-xl font-semibold text-gray-800 mb-4"> Principe de Rétropropagation</h2>
          <p className="text-gray-700 leading-relaxed">
          ...
          <img src="/images/backpropagation_example.png" alt="Exemple de rétropropagation" className="my-4 w-full rounded" />
        </section>
      </div>
  );
};
